	...
	return (
		<View style={styles.navBar}>
		  ...
		  <TouchableOpacity 
			...
			style={[styles.navButton, active === 'Search' && styles.activeButton]}
		  >
		  ...
		  <TouchableOpacity 
			...
			style={[styles.navButton, active === 'Playlist' && styles.activeButton]}
		  >
		  ...
		  <TouchableOpacity 
			...
			style={[styles.navButton, active === 'Player' && styles.activeButton]}
		  >
